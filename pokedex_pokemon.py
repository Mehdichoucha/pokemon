...
pokemon_list = [
    Pokedex(pokemon["name"], pokemon["level"], pokemon["type_pokemon"], pokemon.get("evolution", 'Aucune'), pokemon["attack"], pokemon["defense"], pokemon["hp"], pokemon["speed"], pokemon["xp"])
